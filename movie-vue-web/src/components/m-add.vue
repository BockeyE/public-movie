<template>
    <el-row type="flex" justify="center">
        ...
        <el-col :span="4">
            ...
            <el-upload ref="upload" :headers="headers" :data="movieName" :on-exceed="handleExceed"
                       :on-change="handleChange" :on-success="handleSuccess" :file-list="fileList" :auto-upload="false"
                       :limit="1"
                       class="upload-demo" :action="submitSend()">
...
<script>
    export default {
        ...
        methods: {
          ...
          submitSend:function(){
              return this.$global_.hostName + "/api/jwt/movie/upload.do";
          }
        }
    }
</script>
