...
export default new vuex.Store({
    ...
    mutations: {
        getMovies: state => {
            axios.get(window.location.protocol+'//'+window.location.hostname+':8081' +'/api/movie/list.do').then(function(respone) {
        ...
        getRec: state => {
            ...
            axios
                .get(window.location.protocol+'//'+window.location.hostname+':8081' +'/api/jwt/movie/recommend.do')
        ...
        getAllRate: state => {
            axios.get(window.location.protocol+'//'+window.location.hostname+':8081' +'/api/rate/all.do').then(function (respone) {
        ...
        getRates(state) {
            ...
            axios
                .get(window.location.protocol+'//'+window.location.hostname+':8081' +'/api/jwt/rate/list.do')
                .then(function (respone) {
